...
\def\texinfofonts{Computer Modern}
\def\texinfohacks{(-joke)}
\message{Loading texinfo package [Version \texinfoversion, %
\texinfofonts\space font\space\texinfohacks]:}

% Print the version number if in a .fmt file.
\everyjob{\message{[Texinfo version \texinfoversion, %
\texinfofonts\space font\space\texinfohacks]}\message{}}
...
\font\defbf=cmbx10 scaled \magstep1
